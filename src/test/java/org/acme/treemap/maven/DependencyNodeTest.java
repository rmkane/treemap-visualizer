...
class DependencyNodeTest {
    ...
    void subtreeUniqueBytesCountsEachArtifactOnce() {
        ...
        ArtifactKey logback = new ArtifactKey("ch.qos.logback", "logback-classic", "jar", "1.5", "compile", Optional.empty());
        ArtifactKey core = new ArtifactKey("ch.qos.logback", "logback-core", "jar", "1.5", "compile", Optional.empty());

        DependencyNode root = new DependencyNode(new ArtifactKey("demo", "app", "jar", "1", "compile", Optional.empty()));
