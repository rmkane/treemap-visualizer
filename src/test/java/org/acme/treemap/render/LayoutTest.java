...
class LayoutTest {
    ...
    void horizontalStripPartitionsWidth() {
        List<TreemapLayout.Rect> rects =
                TreemapLayout.layoutStrip(0, 0, 100, 50, true, List.of(10.0, 30.0, 60.0));
    ...
    void verticalStripPartitionsHeight() {
        List<TreemapLayout.Rect> rects =
                TreemapLayout.layoutStrip(0, 0, 100, 100, false, List.of(25.0, 75.0));
    ...
    void zeroSumReturnsEmptyRects() {
        List<TreemapLayout.Rect> rects =
                TreemapLayout.layoutStrip(0, 0, 10, 10, true, List.of(0.0, 0.0));
